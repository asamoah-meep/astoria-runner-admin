...
export interface ApiMonthArticleMonthArticle
  extends Struct.CollectionTypeSchema {
  collectionName: 'month_articles';
  info: {
    displayName: 'MonthArticle';
    pluralName: 'month-articles';
    singularName: 'month-article';
  };
  options: {
...
export interface ApiRunEventRunEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateStr: Schema.Attribute.String;
